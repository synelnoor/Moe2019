...
<div class="form-group col-sm-6">
    ...
    {!! Form::select('dosen',$dosen->pluck('nama','id'),null, ['class' => 'form-control select2']) !!}
</div>
...
<div class="form-group col-sm-12 col-lg-12">
    ...
    {!! Form::textarea('sambutan', null, ['class' => 'form-control']) !!}
</div>

<!-- Submit Field -->
<div class="form-group col-sm-12">
    {!! Form::submit('Save', ['class' => 'btn btn-primary']) !!}
    <a href="{!! route('sambutans.index') !!}" class="btn btn-default">Cancel</a>
</div>
