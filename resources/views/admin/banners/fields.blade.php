...
<div class="form-group col-sm-6">
    ...
    <div id="file-thumb">
         <img src="{{ @$banner->files }}" style="width:100%">
         
    </div>
    <div class="input-group">
        {!! Form::text('file', null, ['class' => 'form-control banner', 'readonly' => 'readonly','placeholder'=>'Default Banner Width: 1024px Height: 487px ']) !!}
...
<div class="form-group col-sm-12 col-lg-12">
    ...
    {!! Form::textarea('desc', null, ['class' => 'form-control rte']) !!}
</div>
...
<script>
    ...
    $(".form-control.banner").on('change',function(){
        console.log('val')
    });
    });
