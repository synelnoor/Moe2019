...
<div class="form-group col-sm-12 col-lg-12">
    ...
    {!! Form::textarea('Visi', null, ['class' => 'form-control rte']) !!}
</div>

<!-- Misi Field -->
<div class="form-group col-sm-12 col-lg-12">
    {!! Form::label('Misi', 'Misi:') !!}
    {!! Form::textarea('Misi', null, ['class' => 'form-control rte']) !!}
</div>

<!-- Tujuan Field -->
<div class="form-group col-sm-12 col-lg-12">
    {!! Form::label('Tujuan', 'Tujuan:') !!}
    {!! Form::textarea('Tujuan', null, ['class' => 'form-control rte']) !!}
</div>

<!-- Halaman Field -->
<div class="form-group col-sm-6">
    {!! Form::label('halaman', 'Halaman:') !!}
    {!! Form::select('halaman',['moes'=>'Moestopo','an'=>'Administrasi Negara','hi'=>'Hubungan Internasional'],null, ['class' => 'form-control select2']) !!}
</div>
