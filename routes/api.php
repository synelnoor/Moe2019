...
Route::resource('artikels', 'ArtikelAPIController');

Route::resource('beritas', 'BeritaAPIController');

Route::resource('articles', 'ArticleAPIController');

Route::resource('visi_misis', 'VisiMisiAPIController');

Route::resource('dosens', 'DosenAPIController');

Route::resource('sambutans', 'SambutanAPIController');

Route::resource('jurnals', 'JurnalAPIController');

Route::resource('bukus', 'BukuAPIController');

Route::resource('kalenders', 'KalenderAPIController');
